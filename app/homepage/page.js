...
import header from '@/components/ui/elements/header.png';
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="flex flex-col max-w-xl">
            ...
            <p className="mt-4 text-[#616161]">
              Bant.ai helps parents protect their children by
              filtering out toxic language, blocking unsafe
              websites, and giving you smart, customizable
              controls. It runs quietly in the background
              so your child can explore safely — and you
              can relax.
            </p>
          ...
          <div className="flex-shrink-0">
            <Image src={header} alt="Header Image" className="w-[600px] h-auto" />
          </div>
        </div>
              {/* Features */}
      <div className="h-100 justify-center mt-10 bg-linear-to-b from-[#ebf1f0] to-[#d8e5e7] rounded-xl pt-10 pb-10">
        <h1 className="text-2xl text-center leading-tight font-bold">
          We're here to help with your concerns</h1>
        
        <p className="mt-3 text-center text-[#616161]">
          Whatever age your kids are, and whatever their needs,
          bant.ai can help reduce the risks they face online.
