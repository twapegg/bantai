      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-[#03585F] pb-5 rounded-2xl items-center justify-center border-1 text-center shadow-sm">
            <h1 className="mt-5 w-14 pt-2 pb-2 mx-auto text-3xl text-[#03585F] rounded-[100] bg-[#D9E5D9] border-1 border-[#D9E5D9]">
              P
            </h1>
          ...
          <div className="bg-[#D9E5D9] pb-5 rounded-2xl items-center justify-center border-1 text-center shadow-sm">
            <h1 className="mt-5 w-14 pt-2 pb-2 mx-auto text-3xl text-[#D9E5D9] rounded-[100] bg-[#03585F] border-1 border-[#03585F]">
              S
            </h1>
        ...
        <div className="mt-5 flex gap-4">
          <div className="w-md rounded-2xl items-center justify-center border-1 shadow-sm">
            <h1 className="pl-4 pt-2 pb-2 rounded-t-2xl text-white font-bold bg-linear-to-r from-[#AFC8AF] to-[#03585F]">
              Filter Settings
            </h1>
          ...
          <div className="w-2xl rounded-2xl items-center bg-white justify-center border-1 shadow-sm">
            <h1 className="pl-4 pt-2 rounded-t-2xl font-bold text-[#03585F]">
              Blocked Sites
            </h1>
            <p className="pl-4 pt-2 font-light">
              These sites are blocked and will not load in the browser.
            </p>
            <div className="flex gap-10">
              <input
                className="ml-4 pl-2 py-2 bg-[#D9E5D9] rounded-xl w-110"
        ...
        <div className="mt-5 bg-white border-1 rounded-lg ">
          <h1 className="pt-6 pl-6 pb-2 text-[#EE9471] font-bold">
            Flagged Event Logs
          </h1>
          <p className="pl-6 pb-2">
            Records of events marked for attention due to unusual or important
            activity.
          </p>
          <input
            className="ml-6 pl-2 py-2 bg-[#D9E5D9] rounded-xl w-110"
