    ...
    <NavBar />
      <div className="flex items-center justify-center bg-[#F8FAFD]">
        <div className="flex h-120 w-250 border border-black/10 rounded-lg shadow-lg overflow-hidden">
          ...
          <h5 className='text-3xl font-bold mb-3 black'>Sign up to <span className='text-[#03585F]'>bant</span>.<span className='text-[#EE9471]'>ai</span></h5>
          <p className='text-2 text-[#616161]'>Create an account and get started!</p>

          {/*This is the initial form of the signup — left side of the card*/}
          <form onSubmit={handleSubmit} className='mt-6 w-7/12'>
              <input name='username' placeholder='Username' onChange={handlechange} value={form.username} className='w-full bg-[#D9E5D9] font-semibold mb-2 px-4 py-3 text-sm rounded-xl placeholder:text-gray'/>
              <input name='email' placeholder='Email' onChange={handlechange} value={form.email} className='w-full bg-[#D9E5D9] font-semibold mb-2 px-4 py-3 text-sm rounded-xl placeholder:text-gray'/>
              
              {/* Password input with visibility toggle */}
              <div className="w-full flex items-center bg-[#D9E5D9] rounded-xl px-4 py-3 mb-2">
                <input name='password' onChange={handlechange} value={form.password} type={passwordVisible ? "text" : "password"} placeholder='Password' className='flex-1 font-semibold bg-transparent text-sm placeholder:text-gray focus:outline-none'/>
              ...
              <div className="w-full flex items-center bg-[#D9E5D9] rounded-xl px-4 py-3 mb-4">
                <input name='cpassword' onChange={handlechange} value={form.cpassword} type={cpasswordVisible ? "text" : "password"} placeholder='Confirm Password' className='flex-1 font-semibold bg-transparent text-sm placeholder:text-gray focus:outline-none'/>
                <button onClick={() => setCPasswordVisible(!cpasswordVisible)} type="button" className="focus:outline-none">
                  {cpasswordVisible ? (
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 ml-2 text-teal-700">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
